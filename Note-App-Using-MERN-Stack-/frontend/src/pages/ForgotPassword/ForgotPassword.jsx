...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-[#09090f] flex items-center justify-center px-4 relative overflow-hidden">
      ...
      {/* Ambient glow orbs */}
      <div className="absolute top-[-120px] left-[-80px] w-[420px] h-[420px] rounded-full bg-indigo-600/20 blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-80px] right-[-80px] w-[360px] h-[360px] rounded-full bg-purple-500/15 blur-[100px] pointer-events-none" />
