...
//                   key={cat}
//                   value={cat}
//                   className="bg-white dark:bg-[#0c0c15] text-slate-800 dark:text-white"
//                 >
//                   {cat}
//                 </option>
//               ))}
...
// [&_button]:text-white [&_button]:hover:text-white
// [&_button_svg]:text-white [&_button_svg]:hover:text-white
...
const AddEditNotes = ({ onClose, noteData, type, getAllNotes }) => {
  ...
  const autoSaveNote = async (currentTitle, currentContent) => {
    ...
    try {
      ...
      getAllNotes();
    } catch (error) { console.log("Auto-save error:", error.message); }
  };
  ...
  return (
    <div className="
      ...
      bg-white dark:bg-[#0c0c15]
      border border-slate-200 dark:border-white/[0.08]
      shadow-[0_24px_60px_rgba(0,0,0,0.2)] dark:shadow-[0_24px_60px_rgba(0,0,0,0.7)]
    ">
      ...
      <div className="flex items-center justify-between px-5 pt-4 pb-3 border-b border-slate-100 dark:border-white/[0.06]">
        <div className="flex items-center gap-2.5">
          <div className="w-8 h-8 rounded-xl bg-indigo-500/10 border border-indigo-500/25 flex items-center justify-center flex-shrink-0">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-3.5 h-3.5 text-indigo-500 dark:text-indigo-400" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              {type === "edit"
          ...
          <div>
            <p className="text-[10px] font-bold tracking-[0.14em] uppercase text-indigo-500 dark:text-indigo-400/80 leading-none mb-0.5">
              {type === "edit" ? "Edit note" : "New note"}
            </p>
            <p className="text-xs text-slate-400 dark:text-white/30 leading-none">
      ...
      <div className="px-4 sm:px-6 pt-4 sm:pt-6 pb-3 sm:pb-5 flex flex-col gap-3.5">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            ...
            <div className="
              ...
              [&_input]:w-full [&_input]:text-sm [&_input]:outline-none [&_input]:transition-all
              [&_input]:rounded-xl [&_input]:px-3 [&_input]:py-2.5 [&_input]:cursor-pointer
              [&_input]:bg-slate-100 dark:[&_input]:bg-white/[0.04]
              [&_input]:border [&_input]:border-slate-200 dark:[&_input]:border-white/[0.08]
              [&_input]:text-slate-800 dark:[&_input]:text-white/85
              [&_input]:focus:border-indigo-400 dark:[&_input]:focus:border-indigo-500/60
              [&_input]:focus:ring-2 [&_input]:focus:ring-indigo-100 dark:[&_input]:focus:ring-indigo-500/20
              [&_svg]:text-indigo-400 [&_svg]:w-3.5 [&_svg]:h-3.5 [&_svg]:flex-shrink-0
            ">
        ...
        <div>
          ...
          <div className="
            ...
            [&_input]:focus:border-indigo-400 dark:[&_input]:focus:border-indigo-500/60
            [&_input]:focus:ring-2 [&_input]:focus:ring-indigo-100 dark:[&_input]:focus:ring-indigo-500/20
            [&_button]:w-10 [&_button]:h-10 [&_button]:flex [&_button]:items-center [&_button]:justify-center
            [&_button]:bg-indigo-600 [&_button]:hover:bg-indigo-500
            [&_button]:text-white [&_button]:rounded-xl [&_button]:transition-all [&_button]:border-0
            [&_button_svg]:w-5 [&_button_svg]:h-5 [&_button_svg]:text-white
            [&_.tag]:bg-indigo-50 dark:[&_.tag]:bg-indigo-500/10
            [&_.tag]:border [&_.tag]:border-indigo-200 dark:[&_.tag]:border-indigo-500/20
            [&_.tag]:text-indigo-600 dark:[&_.tag]:text-indigo-300
            [&_.tag]:rounded-lg [&_.tag]:text-xs [&_.tag]:px-2 [&_.tag]:py-0.5
          ">
            <TagInput tags={tags} setTags={setTags} />
          </div>
        </div>
